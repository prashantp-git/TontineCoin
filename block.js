...
module.exports = class Block {
  ...
  addTransaction(tx, forceAccept) {
    ...
    if (tx.type === "REG" || tx.type === "BND") {                           /*** CS298 PROJECT MODIFICATION: ADD ***/
    ...
    else if (tx.type === "UND") {                                          /*** CS298 PROJECT MODIFICATION: ADD ***/
      this.transactions.set(tx.id,tx);
      let totalIn = 0;
      tx.inputs.forEach(input => {
        if(this.utxos){
    ...
    /*** CS298 PROJECT MODIFICATION: END ***/                                                                       /*** CS298 PROJECT MODIFICATION: ADD ***/
  }
